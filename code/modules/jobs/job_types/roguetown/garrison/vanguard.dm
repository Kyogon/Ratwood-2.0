/datum/job/roguetown/vanguard
	...
	While typically under less supervision than the Men at Arms stationed in hightown, you will be called upon as members of the garrison by the Marshal and Crown. \
